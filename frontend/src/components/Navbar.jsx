    ...
    <div className="flex items-center justify-between py-5 font-medium relative z-50 bg-white">
      ...
      <div className="flex items-center gap-6 relative">
        ...
        <div className="relative">
          ...
          />
          {token && dropdownOpen && (
            <div className="absolute right-0 mt-2 bg-white border rounded-md shadow-lg w-36 z-50">
      ...
      {/* Mobile Sidebar */}
      <div
        className={`absolute top-0 right-0 bottom-0 bg-white transition-all duration-300 ease-in-out z-40 ${
